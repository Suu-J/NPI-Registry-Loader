...
- s3_upload.py -> renamed to NPI_local_to_s3.py -> Needs renaming and comms audit
- s3_uploader_multipart.py -> renamed to NPI_local_to_s3_multipart.py -> consider renaming and comms audit
